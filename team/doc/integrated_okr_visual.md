...
| BF 기간 전체 배송 지연율 | 20.93% (2017 실측) | — | — | 15% 이하 (BF 방어 목표) |

> **원칙**: 팀별 문서에서 위와 다른 수치를 쓰고 있다면 즉시 수정한다.  
> **BF 배송 지연율 구분**: BF-KR4(7.0%)는 "첫 구매 배송 지연율" 기준이며, "BF 기간 전체 배송 지연율"(물류 방어 목표 15%)과 별도로 관리한다.

### Black Friday는 매출 행사가 아니라 재구매 cohort 확보 행사다

2017 BF 실적: 주문량 7.94배 폭증 → 전체 배송 지연율 20.93% → BF cohort 재구매율 1.55% (전체 평균의 절반)  
BF에서 아무리 매출을 올려도, 그 고객이 12~1월에 다시 사지 않으면 전사 OKR에 기여하지 못한다.  
**2018 BF 목표**: 할인 구조(% 할인 → threshold + bundle), 배송 지연율 15% 이하 방어, BF cohort 30일 재구매 1.5~2.0%.
